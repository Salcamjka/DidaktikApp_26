...
class MapActivity : AppCompatActivity(), OnMapReadyCallback, GoogleMap.OnMarkerClickListener {
    ...
    override fun onMapReady(googleMap: GoogleMap) {
        ...
        // Coordenadas de tu tabla convertidas a decimal
    ...
    override fun onMarkerClick(marker: Marker): Boolean {
        when (marker.title) {
            "Antzinako Harresia" -> {
                startActivity(Intent(this, MurallaActivity::class.java))
                return true
            }
            "Zazpi Kaleak" -> {
                startActivity(Intent(this, SopaActivity::class.java))
                return true
            }
            "Txakurraren Iturria" -> {
                startActivity(Intent(this, TxakurraActivity::class.java))
                return true
            }
            "Bilboko Areatza" -> {
